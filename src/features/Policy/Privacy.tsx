import { BugOff, ChartNetwork, Headset, Lock, Mail, Shield } from 'lucide-react'
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-xl p-8">
        ...
        <div className="prose max-w-none">
          <section id="overview" className="mb-12">
            ...
            <p className="mb-4">
              At Xemdi, we are committed to protecting your privacy and ensuring
              the security of your personal information. This Privacy Policy
              explains how we collect, use, disclose, and safeguard your
              information when you use our services.
            </p>
            <p className="mb-4">
              This policy applies to all Xemdi products, services, and websites
              (collectively, "Services"). By using our Services, you consent to
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-blue-700">
                    We never sell your personal data to third parties. Your
          ...
          <section id="data-collection" className="mb-12">
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-4">
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>Profile information (photo, job title, organization)</li>
          ...
          <section id="data-use" className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-4">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-green-700 mt-1">
                      To provide and maintain our Services, authenticate users,
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-blue-700 mt-1">
                      To customize your experience and provide tailored content
                      and recommendations.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-yellow-50 p-4 rounded-lg">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <h3 className="font-medium text-yellow-800">Security</h3>
            ...
            <p className="text-sm text-gray-500">
              We only process personal data when we have a lawful basis to do
              so, including consent, contract fulfillment, legal compliance, and
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-xs text-gray-500">
                      Added CCPA compliance details and expanded data subject
                      rights section
                    </p>
                  </div>
                </div>
